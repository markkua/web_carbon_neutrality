<template>
  <div>
    ...
    <div class="text-body1">
      ...
      year. Over the 21st century, the IPCC projects that in a very high emissions scenario the sea level could rise by
      61–110 cm.
      ...
      While ice-free summers are expected to be rare at 1.5 °C degrees of warming, they are set to occur once every
      three
      to ten years at a warming level of 2 °C. Higher atmospheric CO<sub>2</sub> concentrations have led to changes in
      ocean chemistry.
      An increase in dissolved CO<sub>2</sub> is causing oceans to acidify. In addition, oxygen levels are decreasing as
      oxygen is less
    ...
    <div class="text-body1">
      The science shows clearly that in order to avert the worst impacts of climate change and preserve a livable
      planet,
